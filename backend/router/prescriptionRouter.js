...
router.get("/patient/my-prescriptions", isPatientAuthenticated, getMyPrescriptions);
router.get("/patient/:patientId", isAuthenticated, requireRole(['Doctor', 'Admin', 'Receptionist', 'SuperAdmin']), getPatientPrescriptions);
